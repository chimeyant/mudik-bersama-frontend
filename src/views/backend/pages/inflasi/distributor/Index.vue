      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Data Distributor
          </v-toolbar>
...
export default {
  ...
  data: () => ({
    ...
    marker: {
      ...
      tooltip: "Pilih lokasi distributor",
      draggable: true,
      visible: true,
    },
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/inflasi/distributor",
      pagination: false,
      title: "DATA DISTRIBUTOR",
      subtitle: "Berikut Daftar Distributor Yang Tersedia",
      showtable: true,
      breadcrumbs: [
        {
          text: "Inflasi",
