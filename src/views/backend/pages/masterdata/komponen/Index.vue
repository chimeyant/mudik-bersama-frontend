          ...
          >
            ...
            <template v-slot:item.id="{ value }">
              ...
              >
                ...
                <v-list>
                  <v-list-item @click="openFormTahun(value)">
                    <v-list-item-title>
                      <v-icon
                        :color="theme.color"
                        class="mr-1"
                      >mdi-pencil-circle</v-icon> Atur Tahun
                    </v-list-item-title>
                  </v-list-item>
                  <v-divider></v-divider>
                  <v-list-item
      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Komponen
          </v-toolbar>
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/superadmin/master-data/komponen",
      pagination: false,
      title: "MASTER KOMPONEN",
      subtitle: "Berikut Daftar Seluruh Komponen Yang Tersedia",
      showtable: true,
      breadcrumbs: [
        {
          text: "Data Master",
