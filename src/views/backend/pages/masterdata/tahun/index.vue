              ...
              <template v-slot:activator="{ on }">
                ...
                >
                  <v-icon
                    ...
                    @click="$router.push({name:'master-periode'})"
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl:
        "api/superadmin/master-data/tahun/" + this.$route.params.periode_uuid,
      pagination: false,
      title: "MASTER TAHUN",
      subtitle: "Berikut Daftar Seluruh Tahun Yang Tersedia",
      showtable: true,
      breadcrumbs: [
        {
          text: "Data Master",
